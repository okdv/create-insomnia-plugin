...
export const generatePackageJson = ({replaceWith, replace, blacklist = defaultBlacklist, mergelist = defaultMergelist, settings}: {replaceWith: PackageObject, replace: PackageObject, blacklist?: ReadonlyArray<string>, mergelist?: ReadonlyArray<string>, settings?: Settings}) => {
    if (settings) {
        replaceWith = {
